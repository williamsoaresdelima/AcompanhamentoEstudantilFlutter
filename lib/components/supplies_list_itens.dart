...
class SuppliesListItens extends StatelessWidget {
  const SuppliesListItens(this.school,this.supplie, this.contexts, {super.key});
  ...
  void removeItem(School schoolEdit, Supplies supplieEdit, BuildContext context) async{
      ...
      await SchoolService().Update(schoolEdit.id, jsonEncode(school.toJson()));
       Navigator.of(context).pushNamed(Routes.schoolShowScreen, arguments: schoolEdit);
  } 
  ...
  Widget build(BuildContext context) {
    ...
    return  ListTile(
                ...
                //  removeItem(school, supplie, context)),
                provider.removeItem(school, supplie)),
